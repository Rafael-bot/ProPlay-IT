...
public class NoMeAcuerdo extends JFrame {
	 ...
	 */
	public NoMeAcuerdo() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(NoMeAcuerdo.class.getResource("/ProPlay/Img/logo_size.jpg")));
		...
		textGmail.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (r.validEmail(textGmail.getText())) {
		...
		btnCheck.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (sql.comprobGmail(textGmail.getText()) == "Gmail encontrado") {
					
					textPane.setText(sql.nomeacuerdoq(textGmail.getText()));
					
				} else if(sql.comprobGmail(textGmail.getText()) == "Gmail no encontrado") {
