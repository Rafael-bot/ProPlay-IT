...
public class Login extends JFrame {
	 ...
	 */
	public Login() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Login.class.getResource("/ProPlay/Img/logo_size.jpg")));
		setResizable(false);
		...
		JButton btnNoMeAcuerdo = new JButton("No me acuerdo");
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String busque = sql.comprobUser(textUsuario.getText(), textPassw.getText());		
				Ventana_pagina_principal principal = new Ventana_pagina_principal();
				
				
				if(textUsuario.getText().equals("") || textPassw.getText().equals("")) {
					
					JOptionPane.showMessageDialog(new JFrame(), "Error, rellena los campos", "ProPlay It - Error", JOptionPane.WARNING_MESSAGE);
					
				} else {
				
				if(textUsuario.getText().equals("Admin") && textPassw.getText().equals("admin")) {
					
					if (chckbxRecordar.isSelected() == true) {
						
						mf.escribRecordar(textUsuario.getText(), textPassw.getText());
												
						JOptionPane.showMessageDialog(null, "Login realizado correctamente, como Admin.");
				...
				} else if (busque.equals("Usuario encontrado")) {
					
					if (chckbxRecordar.isSelected() == true) {
					
						mf.escribRecordar(textUsuario.getText(), textPassw.getText());
						
						busque = sql.login(textUsuario.getText());
